                    ...
                    <td colspan="9">
                        <table class="font-x-medium" width="100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($item->orderDetail as $value=>$item1)
                                <tr>
                                    <td class="text-left">{{$value+1}}</td>
                                    <td class="text-left">{{$item1->activity->title??''}}</td>
                                    <td class="text-left">{{$item1->activity_date->date??''}}</td>
                                    <td class="text-left">{{$item1->activity_time_slot->start_date??''}} - {{$item1->activity_time_slot->end_date??''}}</td>
                                    <td class="text-left">{{$item1->quantity??''}}</td>
                                    <td class="text-right">{{$item1->total??''}}</td>
                                </tr>
                                @endforeach
                                @else
                                <tr>
