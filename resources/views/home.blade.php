                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/1.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/10.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/12.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/13.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/15.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-danger p-2 m-1">Processing</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/16.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/17.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-success p-2 m-1">Processing</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/2.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-info p-2 m-1">Processing</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/3.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-warning p-2 m-1">Processing</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/4.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-success p-2 m-1">Processing</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/5.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-info p-2 m-1">Processing</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span>
                                                    <div class="ul-widget_user-card">
                                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/9.jpg')}}" alt="" /></div>
                                                    </div>
                                                </span></td>
                                            <td>11/28/2016</td>
                                            <td><span class="badge badge-pill badge-outline-danger p-2 m-1">Processing</span></td>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="__g-widget4-tab1-content">
                                <div class="ul-widget1">
                                    <div class="ul-widget4__item ul-widget4__users">
                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/1.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                    ...
                                    <div class="ul-widget4__item ul-widget4__users">
                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/2.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                        <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                        <div class="ul-widget4__actions">
                                    ...
                                    <div class="ul-widget4__item ul-widget4__users">
                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/3.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                        <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                        <div class="ul-widget4__actions">
                                    ...
                                    <div class="ul-widget4__item ul-widget4__users">
                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/5.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                        <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                        <div class="ul-widget4__actions">
                            ...
                            <div class="tab-pane" id="__g-widget4-tab2-content">
                                <div class="ul-widget1">
                                    ...
                                    <div class="ul-widget4__item ul-widget4__users">
                                        <div class="ul-widget4__img"><img id="userDropdown" src="{{asset('public/dist-assets/images/faces/4.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                        <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                        <div class="ul-widget4__actions">
                                            <button class="btn btn-outline-info m-1" type="button">Follow</button>
                                        </div>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Smith Doe</td>
                                    <td><img class="rounded-circle m-0 avatar-sm-table" src="{{asset('public/dist-assets/images/faces/1.jpg')}}" alt="" /></td>
