<div class="card mb-4">
    <form id="tourForm" action="{{ url('tour-additional/inclusion-store') }}" method="post" enctype="multipart/form-data">
        @csrf
...
<div class="card text-left">
    <div class="card-body">
        <div class="table-responsive">
            <table id="inclusion_table" class="table table-striped display" style="width:100%">
                <thead>
                    <tr>
