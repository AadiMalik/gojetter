<div class="card mb-4">
    <form id="tourForm" action="{{ url('tour-additional/tour-image-store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        $("body").on("click", "#deleteTourImage", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                            type: "get",
                            url: "{{ url('tour-additional/tour-image-destroy') }}/" + tour_image_id,
                        })
                        .done(function(data) {
                            if (data.Success) {
