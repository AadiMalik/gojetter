...
use App\Services\Concrete\ActivityNotSuitableService;
...
class ActivityNotSuitableController extends Controller
{
    use ResponseAPI;
    protected $activity_not_suitable_service;
    protected $activity_service;

    public function __construct(
        ActivityNotSuitableService $activity_not_suitable_service,
        ActivityService $activity_service
    ) {
        $this->activity_not_suitable_service = $activity_not_suitable_service;
    ...
    public function store(Request $request)
    {
        ...
        try {
            $obj = $request->all();
            $response = $this->activity_not_suitable_service->save($obj);
