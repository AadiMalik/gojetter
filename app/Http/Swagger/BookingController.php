...
class BookingController extends Controller
{
     ...
     *         required=true,
     *         @OA\JsonContent(
     *             required={"tour_id", "tour_date_id", "card_id", "currency_id", "first_name", "last_name", "email", "phone", "country", "zipcode", "address", "quantity", "sub_total", "total", "payment_method", "booking_details"},
     *             @OA\Property(property="tour_id", type="integer", example=1),
     *             @OA\Property(property="tour_date_id", type="integer", example=10),
