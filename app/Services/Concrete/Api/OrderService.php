...
class OrderService
{
      ...
      public function save($data)
      {
            ...
            try {
                  ...
                  $sub_total = $cart_items->sum(fn($item) => $item->quantity * $item->activity->price);
                  ...
                  $order_detail = $this->model_order_detail->getModel()::create($order_detail_obj);
      ...
      {
            $order = $this->model_order->getModel()::with(['orderDetail', 'user', 'card', 'currency'])->find($id);
